...
$title_view_table="Настройка PLC";
$icon_view_table="zwicon-table";
$sql_view_table="
SELECT
	scale_raw_eu.id AS id,
	scale_raw_eu.datatype AS datatype,
	scale_raw_eu.adc_min AS adc_min,
	scale_raw_eu.adc_max AS adc_max,
	scale_raw_eu.eu_min AS eu_min,
	scale_raw_eu.eu_max AS eu_max,
	scale_raw_eu.eu AS eu
FROM 
	scale_raw_eu 
WHERE
1
ORDER BY scale_raw_eu.datatype DESC;
";

$title_view_detail="Редактирование";
$icon_view_detail="zwicon-document";

$sql_main_table="scale_raw_eu"; //для создания/удаления записей
$sql_view_detail="
SELECT
	scale_raw_eu.id AS id,
	scale_raw_eu.datetype AS datatype,
	scale_raw_eu.adc_min AS adc_min,
	scale_raw_eu.adc_max AS adc_max,
	scale_raw_eu.eu_min AS eu_min,
	scale_raw_eu.eu_max AS eu_max,
