...
$(document).ready(function () {
    ...
    if ($("#widget-calendar-body")[0]) {
        ...
        })).render(), $(".widget-calendar__year").html(e.getFullYear()), $(".widget-calendar__day").html(["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][e.getDay()] + ", " + ["January", "February", "March", "April", "May", "June", "July", "Август", "September", "October", "November", "December"][e.getMonth()].substring(0, 3) + " " + e.getDay())
    }
    if ($("#calendar")[0]) {
